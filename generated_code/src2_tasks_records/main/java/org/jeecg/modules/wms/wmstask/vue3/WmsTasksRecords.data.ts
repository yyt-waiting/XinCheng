...
export const superQuerySchema = {
  ...
  execQuantity: {title: '执行数量',order: 3,view: 'number', type: 'number',},
  ...
  batchNumber: {title: '批次号',order: 15,view: 'text', type: 'string',},
  expiryDate: {title: '保质期',order: 16,view: 'date', type: 'string',},
  outOrderId: {title: '出库单id',order: 17,view: 'text', type: 'string',},
  waveSkuSummaryId: {title: '波次拣货明细id',order: 18,view: 'text', type: 'string',},
  sourceWarehouseId: {title: '来源仓库',order: 19,view: 'text', type: 'string',},
  targetWarehouseId: {title: '目的仓库',order: 20,view: 'text', type: 'string',},
};
