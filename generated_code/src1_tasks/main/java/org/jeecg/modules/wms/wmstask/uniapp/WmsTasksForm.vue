			...
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入任务状态" v-model="model.taskStatus"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">完成数量：</text></view>
                  <input type="number" placeholder="请输入完成数量" v-model="model.completedQuantity"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <my-date label="完成时间：" v-model="model.completedAt" placeholder="请输入完成时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/wmstask/wmsTasks/queryById",
                  add: "/wmstask/wmsTasks/add",
                  edit: "/wmstask/wmsTasks/edit",
                },
            }
        },
        created(){
