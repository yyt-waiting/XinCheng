    ...
    <a-tabs v-model:activeKey="activeKey" animated  @change="handleChangeTabs">
      <a-tab-pane tab="包裹明细表" key="wmsShipmentDetail" :forceRender="true">
        <JVxeTable
          ...
          v-if="wmsShipmentDetailTable.show"
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      const wmsShipmentDetailTable = reactive({
        loading: false,
        dataSource: [],
        columns:wmsShipmentDetailColumns,
        show: false
      })
      ...
      const queryByIdUrl = '/shipment/wmsShipment/queryById';
      async function initFormData(){
        let params = {id: props.formData.dataId};
        const data = await defHttp.get({url: queryByIdUrl, params});
        //设置表单的值
        await setFieldsValue({...data});
        requestSubTableData(wmsShipmentDetailList, {id: data.id}, wmsShipmentDetailTable, ()=>{
          wmsShipmentDetailTable.show = true;
        });
        //默认是禁用
