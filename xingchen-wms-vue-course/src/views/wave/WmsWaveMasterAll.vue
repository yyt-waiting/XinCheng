...
<!--      </a-tabs>-->
    ...
    <!--查看拣货路径区域-->
    <WmsWaveMasterPickPathModal @register="registerPickPathModal" ></WmsWaveMasterPickPathModal>
...
<script lang="ts" name="wave-wmsWaveMaster" setup>
  ...
  import WmsWaveMasterPickPathModal from './components/WmsWaveMasterPickPathModal.vue'
  ...
  const [registerPickPathModal, {openModal:openAddPickPathModal}] = useModal();
  ...
  function handleEdit(record: Recordable) {
    ...
    * 查看拣货路径
    */
  function handleOpenAddPickPath(record: Recordable) {
     openAddPickPathModal(true, {
       record
     });
   }
   /**
  ...
  function getTableAction(record){
       return [
         {
           label: '拣货路径',
           onClick: handleOpenAddPickPath.bind(null, record),
         },
         {
           label: '详情',
