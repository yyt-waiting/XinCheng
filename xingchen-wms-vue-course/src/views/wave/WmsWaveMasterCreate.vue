  ...
  <div class="p-2 cgformErpList">
    <div class="content">
      ...
      <BasicTable @register="registerTable" :rowSelection="rowSelection">
        <!--插槽:table标题-->
        <template #tableTitle>
          <a-button type="primary" v-auth="'wave:wms_wave_master:add'"  @click="handleAdd" preIcon="ant-design:plus-outlined"> 创建波次</a-button>
          <a-button type="primary"   @click="handleCreatePickTask" preIcon="ant-design:plus-outlined"> 创建拣货任务</a-button>
<!--          <a-button type="primary" v-auth="'wave:wms_wave_master:exportXls'"  preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>-->
<!--          <j-upload-button type="primary" v-auth="'wave:wms_wave_master:importExcel'"  preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>-->
...
<script lang="ts" name="wave-wmsWaveMaster" setup>
  ...
  import {
    ...
    getImportUrl,
    getExportUrl,
    createPickTask, createShipment, listByCreate
