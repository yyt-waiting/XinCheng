...
import { ROLES_KEY, TOKEN_KEY, USER_INFO_KEY, LOGIN_INFO_KEY, DB_DICT_DATA_KEY, TENANT_ID, OAUTH2_THIRD_LOGIN_TENANT_ID,WAREHOUSE_ID } from '/@/enums/cacheEnum';
...
export const useUserStore = defineStore({
  ...
  getters: {
    ...
    getWarehouse(): string | number {
      return this.warehouseid || getAuthCache<string | number>(WAREHOUSE_ID);
    },
    // 是否有分享租户id
